...
const ProfileForm: FC<ProfileFormProps> = ({ currentPage, changePage }) => {
    ...
    const resetButtonActive = isDirty || formState.profileUri || formState.photoIdUri;
    useEffect(() => {
                ...
                <View style={styles.mainFormContainer}>
                    <View style={[styles.formContent]}>
                        ...
                        <View style={styles.additionalFieldCont}>
                            ...
                            <View style={styles.paymentValidationCont}>
                                ...
                                <Text style={styles.defaultFont} onPress={() => setCashPayment(true)}>
                                    Cash
                                </Text>
                            </View>
                            <View style={styles.paymentValidationCont}>
                                <Checkbox value={!cashPayment} onValueChange={() => setCashPayment(false)} style={styles.checkbox} />
                                <Text style={styles.defaultFont} onPress={() => setCashPayment(false)}>
                                    Charge Member
                                </Text>
                            </View>
                    ...
                    <View style={styles.cameraCont}>
                        <CameraShowButton
                            ...
                            style={isSubmitted && !formState.profileUri ? { backgroundColor: "#8f061f" } : {}}
                    ...
                    <View style={styles.cameraCont}>
                        <CameraShowButton
                            ...
                            style={isSubmitted && !formState.photoIdUri ? { backgroundColor: "#8f061f" } : {}}
                    ...
                    {applicantAge !== undefined && (applicantAge === 0 || applicantAge < 18) && (
                        <View style={styles.cameraCont}>
                            <CameraShowButton
                                ...
                                style={isSubmitted && !formState.guardianPhotoIdUri ? { backgroundColor: "#8f061f" } : {}}
